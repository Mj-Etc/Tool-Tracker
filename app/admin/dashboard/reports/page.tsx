...
import { format, isSameDay, startOfWeek, endOfWeek, startOfMonth, endOfMonth, eachDayOfInterval, isSameMonth } from "date-fns";
...
export default function ReportsPage() {
  const [reportMode, setReportMode] = useState<"daily" | "weekly" | "monthly" | "overall">("daily");
  ...
  const { startDate, endDate } = useMemo(() => {
    ...
    if (reportMode === "weekly") {
      return { startDate: startOfWeek(selectedDate), endDate: endOfWeek(selectedDate) };
    }
  ...
  const chartData = useMemo(() => {
    if (!transactions || reportMode === "overall") return [];
        ...
        <div className="space-y-8 animate-in fade-in duration-500">
          ...
          <Tabs defaultValue="overview" className="space-y-6">
            ...
            <TabsContent value="overview" className="space-y-6 outline-none">
              {/* Revenue Trend Chart */}
              {reportMode !== "daily" && reportMode !== "overall" && (
                <Card className="shadow-sm">
                  <CardHeader>
