    ...
    () => [
      ...
      },
      {
        ...
        cell: ({ row }) => {
          ...
          return (
            <div className="ml-1 font-mono font-semibold text-sm">
      ...
      },
      {
        ...
        cell: ({ row }) => {
          ...
          return (
            <div className={`ml-1 font-mono text-sm font-semibold ${colorClass}`}>
              {quantity}
            </div>
          );
        },
      ...
      {
        id: "actions",
        header: () => <span className="text-right text-[10px] uppercase font-bold tracking-wider block">Action</span>,
        cell: ({ row, table }) => {
            ...
            {table.getHeaderGroups().map((headerGroup) => (
              <TableRow key={headerGroup.id} className="hover:bg-transparent border-b">
                {headerGroup.headers.map((header) => (
                  <TableHead key={header.id} className="h-8 py-0 px-4">
